...
import conexionBase.conexionEntrena2;
 ...
 * @author CarlosEfrain
 */
public class Entrenamiento2 extends javax.swing.JInternalFrame  {
...
public String texto; 
public static conexionEntrena2 obj;
       ...
       txte.addKeyListener(new KeyAdapter()
          {
           ...
           public void keyTyped(KeyEvent e )
              ...
              if (txtrm.getText().equals(""))
                {JOptionPane.showMessageDialog(null,"Primero ingrese el 1rm","Advertencia",JOptionPane.WARNING_MESSAGE);
                 e.consume();}
                try {
            Double.parseDouble(txte.getText()+e.getKeyChar());
            calcularPorcentaje(Double.parseDouble(txte.getText()+e.getKeyChar()));
        } catch (Exception ex) {
           if(txte.getText().equals("")) calcularPorcentaje(0);
            e.consume();
        }  
                  }});
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(comboSemana, javax.swing.GroupLayout.Alignment.LEADING, 0, 175, Short.MAX_VALUE)
...
universales();
   lstEntrenadores2  dialog = new lstEntrenadores2(new javax.swing.JFrame(), true);
   ...
   universales();
   lstEntrenamiento21  dialog2 = new lstEntrenamiento21(new javax.swing.JFrame(), true);
    ...
    {JOptionPane.showMessageDialog(null,"Primero ingrese el 1rm","Advertencia",JOptionPane.WARNING_MESSAGE);
     evt.consume();}
        try {
            ...
            calcularPorcentaje(Double.parseDouble(txte.getText()+evt.getKeyChar()));
        } catch (Exception e) {
           if(txte.getText().equals("")) calcularPorcentaje(0);
            evt.consume();
        }   }     // TODO add your handling code here:
 ...
 universales();    // TODO add your handling code here:
   ...
   JOptionPane.showMessageDialog(null,"gano :)");
    ...
    private void txtrmKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtrmKeyTyped
      try {
            Double.parseDouble(txtrm.getText()+evt.getKeyChar());
...
public static void guardarEntrenamiento (){
    ...
    if (txtnombre.isEnabled()){
     ...
     for( int s=1;s <= sema; s++ ){       
     for ( int d=1;d <= dia; d++ ){
                    //JOptionPane.showMessageDialog(null,encabezado.getValueAt(cont,3)+ "esta guradando");
                    peso= Double.parseDouble((String) encabezado.getValueAt(cont,3));
...
public void universales(){
 miprincipal.planprin=false;
     ...
     miprincipal.entrenamiento2=true;
     miprincipal.usuario=false;
     miprincipal.federado=false; }

public void calcularPorcentaje(double valor){
    
    double porcentaje=(valor*100)/Double.parseDouble(txtrm.getText());
   // JOptionPane.showMessageDialog(null, porcentaje);
    encabezado.setValueAt(formatter.format(porcentaje), tbltabla.getSelectedRow(), 3);
}
