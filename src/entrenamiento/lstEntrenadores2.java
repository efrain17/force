 ...
 * @author CarlosEfrain
 */
public class lstEntrenadores2 extends javax.swing.JDialog {
     ...
     */
    public lstEntrenadores2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarEntrenadorTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un entrenador","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            Entrenamiento2.txtcodentrenador.setText(cedula);
            Entrenamiento2.txtnombreentrenador.setText(nombre);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstEntrenadores2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
