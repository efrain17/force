 ...
 * @author CarlosEfrain
 */
public class lstUsuariosCargar extends javax.swing.JDialog {
    conexionUsuarios obj; 
    DefaultTableModel m;
    int columbuscar=1;
     ...
     */
    public lstUsuariosCargar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        
        
obj=new conexionUsuarios();
obj.consultarUsuarioTotal(tbltablaEntrenador);
    }
    ...
    private void initComponents() {
        ...
        btnselecEntrenador.setText("Seleccionar ");
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un deportista","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            Usuarios.TXTcedula.setText(cedula);
            Usuarios.TXTcedula.setEnabled(false);
            obj.consultarUsuarioCargar(cedula);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstUsuariosCargar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
