 ...
 * @author CarlosEfrain
 */
public class lstEntrenadorCargar extends javax.swing.JDialog {
     ...
     */
    public lstEntrenadorCargar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarEntrenadorTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un deportista","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            Entrenador.TXTcedula.setText(cedula);
            Entrenador.TXTcedula.setEnabled(false);
            obj.consultarEntrenadorCargar(cedula);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstEntrenadorCargar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
