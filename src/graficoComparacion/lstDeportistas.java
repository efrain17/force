 ...
 * @author CarlosEfrain
 */
public class lstDeportistas extends javax.swing.JDialog {
     ...
     */
    public lstDeportistas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarFederadoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un deportista","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            GraficoComparacion.txtcedula.setText(cedula);
            GraficoComparacion.txtnombredeportista.setText(nombre);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstDeportistas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
