 ...
 * @author CarlosEfrain
 */
public class lstDeportistasEntreno extends javax.swing.JDialog {
     ...
     */
    public lstDeportistasEntreno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarFederadoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un entrenador","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            EntrenamientoCargado.txtcedula.setText(cedula);
            EntrenamientoCargado.txtnombre.setText(nombre);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstDeportistasEntreno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
