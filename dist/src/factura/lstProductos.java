 ...
 * @author CarlosEfrain
 */
public class lstProductos extends javax.swing.JDialog {
    conexionFactura obj; 
    DefaultTableModel m;
    int columbuscar=1;
     ...
     */
    public lstProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarProductoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un entrenador","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            obj.consultarProductoTabla(Factura.tblProductosfac, codigo,cant);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
