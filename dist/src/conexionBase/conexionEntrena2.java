 ...
 * @author PC
 */
public class conexionEntrena2 extends conexionBase {
...
public conexionEntrena2()
    { conectar("com.mysql.jdbc.Driver",  "jdbc:mysql://localhost:3306/force", "root","123456"); }

//*************************************************************************************************+
public conexionEntrena2(  String nombrecliente1,  String apellido1, String cedula1, String telefono1, String direccion1, String sex,int nc)
...
"where entrenamiento.idEntreno='"+identreno+"' and entrenador.identrenador=entrenamiento.identrenador ";
 ...
 try {sentencia_sql =  miConexion.prepareStatement(sql);
             ...
             while (rs.next()) {
                 cnt=cnt+1; 
                 Entrenamiento2.comboSemana.setSelectedItem(rs.getString("semana"));
                 Entrenamiento2.comboDias.setSelectedItem(rs.getString("dia"));
                 Entrenamiento2.combCategoria.setSelectedItem(rs.getString("tipo"));
                 Entrenamiento2.txtcodentrenador.setText(rs.getString("identrenador"));
                 Entrenamiento2.txtnombreentrenador.setText(rs.getString("nombres")+" "+rs.getString("apellidos"));
