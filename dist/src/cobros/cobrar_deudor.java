 ...
 * @author CarlosEfrain
 */
public class cobrar_deudor extends javax.swing.JDialog {
...
String user="1313375980";
     ...
     */
    public cobrar_deudor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        cuentas.consultarCuotasPagar(jTable1, cuentas_por_cobrar.cedulaCliente);
        ...
        /////////////
       txtnombrecliente.setText(cuentas_por_cobrar.nombreCliente);
       txtcedulaCliente.setText(cuentas_por_cobrar.cedulaCliente);
       txtcedularecibo.setText(cuentas_por_cobrar.cedulaCliente);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if (Double.parseDouble(txtmonto.getText())>0)  {
        ...
        try {
            pagar();
            cuentas.ingresarPago(Double.parseDouble(txtmonto.getText()),txtdescripcion.getText() , txtobservacion.getText(),fecha.format(fechaEmitidaChoser.getDate()) ,txtcedulaCliente.getText());
            Date date=calendar.getTime();
               micaja.consultarCajaID(user);
               micaja.ingresarCajaOperacion(micaja.getidcaja(), fechadf.format(date ), horadf.format(date), "Cnt cobrar: "+txtcedulaCliente.getText(), Double.parseDouble(txtmonto.getText()));
               micaja.modificarCajaTotal(user, Double.parseDouble(txtmonto.getText()));
            limpiarPagos();
            calculador(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cobrar_deudor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public void pagar(){
    ...
    for (int i = 0; i < jTable1.getRowCount(); i++) {
        if ( jTable1.getValueAt(i, 8)!=null && !jTable1.getValueAt(i, 8).toString().equals("")){
            ...
            cuentas.modificarCuentaPago(Integer.parseInt(jTable1.getValueAt(i, 0).toString()), Double.parseDouble(jTable1.getValueAt(i, 8).toString()), cuentas_por_cobrar.cedulaCliente);
            cuentas.modificarCuentaValorCobrar(Integer.parseInt(jTable1.getValueAt(i, 0).toString()), Double.parseDouble(jTable1.getValueAt(i, 8).toString()), cuentas_por_cobrar.cedulaCliente);
        }
    }
}
