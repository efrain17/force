 ...
 * @author CarlosEfrain
 */
public class lstProveedores extends javax.swing.JDialog {
    conexionCompra obj; 
    DefaultTableModel m;
    int columbuscar=1;
     ...
     */
    public lstProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarProveedoresTotal(tbltablaEntrenador);
    }
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un entrenador","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            Compra.txtcodigocliente.setText(cedula);
            Compra.txtNombreCliente.setText(nombre);
            Compra.txtDireccionCliente.setText(tbltablaEntrenador.getValueAt(fselec,3).toString());
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
