 ...
 * @author CarlosEfrain
 */
public class lstProductosCompra extends javax.swing.JDialog {
    conexionCompra obj; 
    DefaultTableModel m;
    int columbuscar=1;
     ...
     */
    public lstProductosCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        
        
obj=new conexionCompra();
obj.consultarProductoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"Seleccione un producto","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            obj.consultarProductoTabla(Compra.tblProductosfac, codigo,cant);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstProductosCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
