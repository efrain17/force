 ...
 * @author CarlosEfrain
 */
public class lstTerminoPagoCompra extends javax.swing.JDialog {
     ...
     */
    public lstTerminoPagoCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
  ...
  factu.consultarTerminoTotal(tbltermino);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un Termino","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            Compra.txttermino.setText(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstTerminoPagoCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
