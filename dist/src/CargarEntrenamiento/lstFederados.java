 ...
 * @author CarlosEfrain
 */
public class lstFederados extends javax.swing.JDialog {
     ...
     */
    public lstFederados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarFederadoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un entrenador","Advertencia",JOptionPane.WARNING_MESSAGE);
            ...
            cargarEntreno.txtcodigofederado.setText(cedula);
            cargarEntreno.txtnombrefederado1.setText(nombre);
            obj.consultarFederado(cedula);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstFederados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
