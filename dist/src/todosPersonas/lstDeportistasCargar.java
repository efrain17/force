...
import graficoComparacion.*;
import CargarEntrenamiento.*;
 ...
 * @author CarlosEfrain
 */
public class lstDeportistasCargar extends javax.swing.JDialog {
     ...
     */
    public lstDeportistasCargar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
obj.consultarFederadoTotal(tbltablaEntrenador);
    ...
    private void initComponents() {
        ...
        btnselecEntrenador.setText("Seleccionar Deportista");
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 79, Short.MAX_VALUE))
        );
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"seleccione un deportista","Advertencia",JOptionPane.WARNING_MESSAGE);
         else {
            ...
            federadoFrame.TXTcedula.setText(cedula);
            federadoFrame.TXTcedula.setEnabled(false);
            obj.consultarFederadoCargar(cedula);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstDeportistasCargar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
