 ...
 * @author CarlosEfrain
 */
public class lstProductoskardex extends javax.swing.JDialog {
    conexionkardex obj; 
    DefaultTableModel m;
    int columbuscar=1;
     ...
     */
    public lstProductoskardex(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        
        
obj=new conexionkardex();
obj.consultarProductoTotal(tbltablaEntrenador);
    ...
    private void btnselecEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnselecEntrenadorActionPerformed
        ...
        if (fselec==-1)JOptionPane.showMessageDialog(null,"Seleccione un producto","Advertencia",JOptionPane.WARNING_MESSAGE);
         else {
            codigo= tbltablaEntrenador.getValueAt(fselec,0).toString();
            nombre=tbltablaEntrenador.getValueAt(fselec,1).toString();
            precio=tbltablaEntrenador.getValueAt(fselec,2).toString();
            cant=Double.parseDouble(tbltablaEntrenador.getValueAt(fselec,3).toString());
            kardex.txtcodigokardex.setText(codigo);
            kardex.txtnombrekardex.setText(nombre);
            kardex.txtstockkardex.setText(precio);
...
columbuscar=2;        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lstProductoskardex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
