   ...
   public static  XYSeriesCollection datosxy=new XYSeriesCollection();
    ...
    public  graficakardex(){ 
       ...
       int n=y.length;
        ...
        graficaxy=ChartFactory.createXYLineChart("Grafica de Stock de Producto",  "transacciones", "cantidades",datosxy, PlotOrientation.VERTICAL, true, true, true);
    ...
    public graficakardex(double[] peso){
